 ...
 */
class old_CommandHandler extends SimpleChannelInboundHandler<AbstractCommand>{
    private static final Logger logger = LoggerFactory.getLogger(old_CommandHandler.class);
