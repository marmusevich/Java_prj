 ...
 *
 */
public final class old_NetServer {

    private EventLoopGroup bossGroup;
    private EventLoopGroup workerGroup;
    private SslContext sslCtx;

    private static final Logger logger = LoggerFactory.getLogger(old_NetServer.class);


    /**
     * иницилизировать, количество потоков на усмотрение системы
     */
    public old_NetServer() {
        this(0,0);
    }
     ...
     */
    public old_NetServer(int bossThreads, int workerThreads) {
        if(bossThreads == 0)
...
//                    .childOption(ChannelOption.SO_TIMEOUT,128)
                    ...
                    .childHandler(new old_NetServerChannelInitializer(sslCtx, netCharset ));
