...
class old_BateToCommandDecoder extends ByteToMessageDecoder {
    private static final Logger logger = LoggerFactory.getLogger(old_BateToCommandDecoder.class);

    private final Charset charset;

    public old_BateToCommandDecoder(Charset charset) {
        if (charset == null) {
